...
pip wheel --no-index --no-deps --wheel-dir dist dist/labpack-0.22.tar.gz

Upload (or Register) Distributions to PyPi:
twine upload dist/labpack-0.22*
...
pip install dist/labpack-0.22-py3-none-any.whl # when possessing wheel file
