...
pip wheel --no-index --no-deps --wheel-dir dist dist/labpack-0.19.tar.gz

Upload (or Register) Distributions to PyPi:
twine upload dist/labpack-0.19*
...
pip install dist/labpack-0.19-py3-none-any.whl # when possessing wheel file
